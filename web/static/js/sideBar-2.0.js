;(function($){
	...
	var defaultConf = {
		...
		url: {
			feedBackURL: '//accounts.ctrip.com/MyCtrip/Community/CommunityAdvice.aspx',
			liveChatURL: '//livechat.ctrip.com/livechat/Login.aspx?GroupCode=CustomerService&AsFrom=1'
		},

		bgSrc: {
			src: '//pic.c-ctrip.com/common/un_sidebar.png',
			srcIE6: '//pic.c-ctrip.com/common/un_sidebar_8.png'
		},
